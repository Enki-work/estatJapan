...
abstract class FlutterPurchaseModelApi {
  ...
  static void setup(FlutterPurchaseModelApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.FlutterPurchaseModelApi.sendPurchaseModel', codec, binaryMessenger: binaryMessenger);
      if (api == null) {
